...
namespace LyraGameplayTags
{
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_ManaShield);
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_RecoverMana);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_DecreaseMana);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_ManaShield);

	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(HUD_Slot_ManaShield_Show);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(HUD_Slot_ManaShield_Hide);
