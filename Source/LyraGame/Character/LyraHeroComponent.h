...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Lyra|Hero")
	UGameplayEffect* GetManaDecreaseClass() const { return (ManaDecreaseEffectClass ? ManaDecreaseEffectClass->GetDefaultObject<UGameplayEffect>() : nullptr); } 

	UFUNCTION(BlueprintPure, Category = "Lyra|Hero")
	UGameplayEffect* GetManaCooldownClass() const { return (ManaCooldownEffectClass ? ManaCooldownEffectClass->GetDefaultObject<UGameplayEffect>() : nullptr); }
...
protected:
	...
	TSubclassOf<UGameplayEffect> ManaDecreaseEffectClass;

	UPROPERTY(EditAnywhere, meta = (AllowPrivateAccess = "true"), Category = GameplayEffect)
	TSubclassOf<UGameplayEffect> ManaCooldownEffectClass;
