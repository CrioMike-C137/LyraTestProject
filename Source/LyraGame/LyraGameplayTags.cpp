...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_ManaShield, "Ability.ManaShield", "An ability absorbs damage.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_RecoverMana, "Status.RecoverMana", "Target has recover mana status.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_DecreaseMana, "Status.DecreaseMana", "Target has the decrease mana status.");	  
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_ManaShield, "Status.ManaShield", "Target has mana shield status.");

	UE_DEFINE_GAMEPLAY_TAG_COMMENT(HUD_Slot_ManaShield_Show, "HUD.Slot.ManaShield.Show", "ManaShield widget show.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(HUD_Slot_ManaShield_Hide, "HUD.Slot.ManaShield.Hide", "ManaShield widget hide.");
